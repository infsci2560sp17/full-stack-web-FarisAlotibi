...
//------------------
	...
	public ModelAndView createNewUser(@Valid User user, BindingResult bindingResult) {
		...
		if (userExists != null) {
			bindingResult
					.rejectValue("email", "error.user", "There is already a user registered with the email/username provided");
		}
		if (bindingResult.hasErrors()) {
			modelAndView.setViewName("registration");
		} else {
			userService.saveUser(user);
			modelAndView.addObject("successMessage", "User was successfully registered!");
